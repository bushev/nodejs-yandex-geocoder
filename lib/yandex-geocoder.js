...
class YandexGeocoder {
    ...
    resolve(query, options, callback) {
        ...
        this.resolveQuery(geoRequest, callback);
    }
    ...
    buildRequest(query, options) {
        ...
        var q = 'geocode=' + encodeURIComponent(query) + '&results=' + results + '&format=json&key=' + this.apiKey;
     ...
     * @param callback
     */
    resolveQuery(geoRequest, callback) {
